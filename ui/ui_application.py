...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.showCtrlCBox = QtWidgets.QCheckBox(self.widget)
        self.showCtrlCBox.setObjectName("showCtrlCBox")
        self.horizontalLayout_7.addWidget(self.showCtrlCBox)
        self.showCrLfCBox = QtWidgets.QCheckBox(self.widget)
